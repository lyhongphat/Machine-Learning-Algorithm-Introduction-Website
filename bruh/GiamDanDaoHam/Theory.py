...
def executeThisFunction():
    ...
    filepath = os.path.join(currentDir, "../assets/images/giamDanDaoHam/AnhGiamDanDaoHamGioiThieu.png")
    image = Image.open(filepath)
    st.image(image, caption='', use_column_width=True)
    ...
    filepath = os.path.join(currentDir, "../assets/images/giamDanDaoHam/congThuc1LT.png")
    image = Image.open(filepath)
    st.image(image, caption='', use_column_width=True)
    ...
    filepath = os.path.join(currentDir, "../assets/images/giamDanDaoHam/congThuc2LT.png")
    image = Image.open(filepath)
    st.image(image, caption='', use_column_width=True)
