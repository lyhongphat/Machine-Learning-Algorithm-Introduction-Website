...
class Main():
    ...
    def initUI(self):
        with st.sidebar:
            selected = option_menu("Main Menu", ["End to end project", 'Giam dan dao ham','Giam dam dao ham momentum',"Hoi quy", "KNN","Overfitting", "SVM"],
                icons=['person lines fill', 'apple','book', 'apple','apple','apple','apple'], menu_icon="cast", default_index=1)
            selected

        if selected=="End to end project":
            st.title("End to end project")

        elif selected=='Giam dan dao ham':
        ...
        elif selected == 'Giam dam dao ham momentum':
